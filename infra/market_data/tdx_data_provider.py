...
class TdxDataProvider(_ProviderHealthMixin, TdxDataProviderHistoryMixin, TdxDataProviderRealtimeMixin):
    ...
    def get_quote_request_stats(self) -> dict:
        ...
        return {
            ...
            "recent_network_result_count": recent.get("network_result_count", 0),
            "recent_stale_result_count": recent.get("stale_result_count", 0),
            "recent_result_count": recent.get("result_count", 0),
            "recent_missing_result_count": recent.get("missing_result_count", 0),
            "recent_latest_quote_time": recent.get("latest_quote_time", ""),
