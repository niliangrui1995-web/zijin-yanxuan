...
class MainWindowQT(QMainWindow):
    ...
    def __init__(self, splash=None):
        ...
        # 全局样式设置 (Global Style Sheet - Modern Web3 Dark Theme)
        self.setStyleSheet("""
            /* ═══════════════════════════════════════════
               紫金研选量化终端 - 全局深色主题 QSS v2
            ...
            /* ═══════════════════════════════════════════
               QPushButton - 按钮系统（增强版）
               最小触控高度 36px，hover 过渡
               ═══════════════════════════════════════════ */
            QPushButton {
            ...
            QPushButton#ctaButton:pressed, QPushButton[class="primary"]:pressed {
                background: #6D28D9;
            }
            QPushButton#ctaButton:disabled, QPushButton[class="primary"]:disabled {
                background: #374151;
                color: #6B7280;
            }
            ...
            QPushButton[class="segmentControl"]:hover {
                background: #374151;
                color: #E2E8F0;
            }
