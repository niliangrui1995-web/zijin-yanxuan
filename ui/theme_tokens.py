...
def build_ui_tokens(theme: dict | None = None, density: str | None = None) -> dict:
    ...
    table = {
        ...
        "current_cell_bg": _hex_to_rgba(theme["BRAND_PRIMARY"], 0.10 if is_dark else 0.06),
        "current_cell_bg_selected": _hex_to_rgba(theme["BRAND_PRIMARY"], 0.16 if is_dark else 0.10),
        "current_cell_border": theme["BRAND_DEEP"],
