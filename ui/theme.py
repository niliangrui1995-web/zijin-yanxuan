...
THEME_YUEBAI = {
    ...
    "BG_TABLE_HOVER": "#F0F5FF",
    "BG_BUTTON": "#F5F6FA",
    "BG_BUTTON_HOVER": "#EDF2FF",
    "BG_MENU": "#FFFFFF",
    "BG_GLASS": "rgba(249, 249, 251, 0.97)",
    "BG_TOOLBAR": "#FFFFFF",
    "BG_TOOLBAR_CARD": "#FFFFFF",
    "BG_TOOLBAR_CHIP": "#F3F5FA",
    ...
    "BORDER_STRONG": "rgba(15, 23, 42, 0.10)",
    ...
    "STATUSBAR_BORDER": "rgba(0, 0, 0, 0.06)",
    # 齿轮菜单选中色
    ...
    "KLINE_TOOLBAR_BORDER": "rgba(0, 0, 0, 0.06)",
    ...
    "KLINE_SUMMARY_BORDER": "rgba(0, 0, 0, 0.06)",
...
THEME_YAOHEI = {
    ...
    "BG_TABLE_ALT_ROW": "#090909",
    "BG_TABLE_HOVER": "#141414",
    "BG_BUTTON": "#111111",
    "BG_BUTTON_HOVER": "#1A1A1A",
    "BG_MENU": "#080808",
    "BG_GLASS": "rgba(0, 0, 0, 0.96)",
    "BG_TOOLBAR": "#050505",
    "BG_TOOLBAR_CARD": "#0A0A0A",
    "BG_TOOLBAR_CHIP": "#111111",
    # 文字色
    "TEXT_PRIMARY": "#F2F6FF",
    ...
    "KLINE_BG_CANVAS": "#080808",
    "KLINE_BG_TOOLBAR": "#080808",
    "KLINE_WIDGET_BG": "#080808",
    "KLINE_WIDGET_TEXT": "#F2F6FF",
    "KLINE_TOOLBAR_BG": "#080808",
    "KLINE_TOOLBAR_BORDER": "rgba(96, 115, 148, 0.20)",
    "KLINE_SUMMARY_BG": "#080808",
    "KLINE_INFO_COLOR": "#B7C2D8",
    "KLINE_BTN_BORDER": "#42516E",
    "KLINE_BTN_HOVER_BG": "#141414",
    "KLINE_BTN_HOVER_TEXT": "#F2F6FF",
    "KLINE_BTN_DISABLED_TEXT": "#5F6D86",
    "KLINE_BTN_DISABLED_BORDER": "rgba(96, 115, 148, 0.24)",
    "KLINE_CHART_BG": "#080808",
    "KLINE_NAV_BG": "#111111",
    "KLINE_BADGE_BG": "rgba(85, 183, 255, 0.16)",
    "KLINE_BADGE_FG": "#DCEEFF",
    "KLINE_SUMMARY_BORDER": "rgba(96, 115, 148, 0.20)",
