...
THEME_YUEBAI = {
    ...
    # 功能色 — 涨跌（白底加深版，确保对比度）
    "COLOR_RISE": "#C83E36",
    "COLOR_RISE_STRONG": "#A92E29",
    "COLOR_FALL": "#16845D",
    "COLOR_FALL_STRONG": "#0D6F4E",
    "COLOR_FLAT": "#64748B",
    # 功能色 — 状态（不变）
    ...
    "KLINE_UP_COLOR": "#C83E36",
    "KLINE_DOWN_COLOR": "#16845D",
    "KLINE_UP_GRADIENT_TOP": "#F06455",
    "KLINE_UP_GRADIENT_BOTTOM": "#B93A32",
    "KLINE_UP_BORDER": "#D8584C",
    "KLINE_DOWN_GRADIENT_TOP": "#2AA876",
    "KLINE_DOWN_GRADIENT_BOTTOM": "#146343",
    "KLINE_DOWN_BORDER": "#1B8F65",
    "KLINE_MA10": "#1F2933",
    "KLINE_MA20": "#315F86",
    "KLINE_MA50": "#B36B2C",
    "KLINE_MA150": "#5F6F82",
    ...
    "KLINE_MA_RIBBON_UP": "rgba(200, 62, 54, 0.08)",
    "KLINE_MA_RIBBON_DOWN": "rgba(22, 132, 93, 0.08)",
...
THEME_YAOHEI = {
    ...
    "BG_CANVAS": "#0B1017",
    "BG_SIDEBAR": "#0B1017",
    "BG_SIDEBAR_END": "#111822",
    "BG_TABLE_ALT": "#111822",
    "BG_CARD": "#151C26",
    "BG_HOVER": "rgba(78, 127, 168, 0.10)",
    "BG_INPUT": "#0F1620",
    "BG_ELEVATED": "#1A2330",
    "BG_TITLEBAR": "#0B1017",
    "BG_STATUSBAR": "#0B1017",
    "BG_TABLE_BASE": "#0D141D",
    "BG_TABLE_ALT_ROW": "#111A24",
    "BG_TABLE_HOVER": "#172230",
    "BG_BUTTON": "#151E29",
    "BG_BUTTON_HOVER": "#1B2735",
    "BG_MENU": "#151C26",
    "BG_GLASS": "rgba(21, 28, 38, 0.96)",
    "BG_TOOLBAR": "#0E151E",
    "BG_TOOLBAR_END": "#151C26",
    "BG_TOOLBAR_CARD": "#151C26",
    "BG_TOOLBAR_CHIP": "#151E29",
    # 文字色
    "TEXT_PRIMARY": "#E8EDF3",
    ...
    # 功能色 — 涨跌
    "COLOR_RISE": "#E05243",
    "COLOR_RISE_STRONG": "#F06455",
    "COLOR_FALL": "#2AA876",
    "COLOR_FALL_STRONG": "#1E8B5D",
    "COLOR_FLAT": "#C4CCD6",
    # 功能色 — 状态
    ...
    "NETWORK_BUSY": "#C9913A",
    # K线图专用色
    "KLINE_UP_COLOR": "#E05243",
    "KLINE_DOWN_COLOR": "#2AA876",
    "KLINE_UP_GRADIENT_TOP": "#F06455",
    "KLINE_UP_GRADIENT_BOTTOM": "#B93A32",
    "KLINE_UP_BORDER": "#FF7D70",
    "KLINE_DOWN_GRADIENT_TOP": "#2AA876",
    "KLINE_DOWN_GRADIENT_BOTTOM": "#146343",
    "KLINE_DOWN_BORDER": "#3DFFB4",
    ...
    "KLINE_MA_RIBBON_UP": "rgba(224, 82, 67, 0.08)",
    "KLINE_MA_RIBBON_DOWN": "rgba(42, 168, 118, 0.08)",
