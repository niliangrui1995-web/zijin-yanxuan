# -*- coding: utf-8 -*-
"""Qt implementation for the process-wide quote snapshot store."""
...
from core.state.quote_snapshot import QuoteSnapshot, get_missing_a_share_finance_codes, merge_quote_snapshot
...
class GlobalStore(QObject):
    ...
    def merge_quotes(self, data: Mapping | None) -> QuoteSnapshot:
        ...
        with self._state_lock:
            ...
            new_snapshot, observed_snapshot = merge_quote_snapshot(
                old_snapshot,
                data,
